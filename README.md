...
[LTI Launch Data Flow Diagram](./LTI_Launch.md)
...
The SAM CLI can also emulate your application's API. Use `sam local start-api` to run the API locally on port 3000.
...
To simplify troubleshooting, SAM CLI has a `sam logs` command. It lets you fetch logs generated by your deployed Lambda function from the command line. In addition to printing the logs on the terminal, this command has several nifty features to help you quickly find the bug.
